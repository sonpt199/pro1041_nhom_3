...
public class BlankPlotChartColumn extends JComponent {

    public BlankPlotChatRenderChartColumn getBlankPlotChatRender() {
        return blankPlotChatRender;
    }

    public void setBlankPlotChatRender(BlankPlotChatRenderChartColumn blankPlotChatRender) {
    ...
    private NiceScaleChartColumn niceScale;
    private double maxValues;
    private double minValues;
    private int labelCount;
    private String valuesFormat = "#,##0.##";
    private BlankPlotChatRenderChartColumn blankPlotChatRender;

    public BlankPlotChartColumn() {
    ...
    public void initValues(double minValues, double maxValues) {
        ...
        this.maxValues = maxValues;
        niceScale = new NiceScaleChartColumn(minValues, maxValues);
        repaint();
    }
    ...
    public SeriesSizeChartColumn getRectangle(int index, double height, double space, double startX, double startY) {
        double x = startX + space * index;
        SeriesSizeChartColumn size = new SeriesSizeChartColumn(x, startY+1, space, height);
        return size;
    }
