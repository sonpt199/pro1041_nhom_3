...
public class ShadowRendererForNoti {
    ...
    public ShadowRendererForNoti() {
        this(5, 0.5f, Color.BLACK);
    }

    public ShadowRendererForNoti(final int size, final float opacity, final Color color) {
        this.size = size;
    ...
    public BufferedImage createShadow(final BufferedImage image) {
        ...
        GraphicsUtilitiesForNoti.getPixels(image, 0, 0, srcWidth, srcHeight, srcBuffer);
        ...
        GraphicsUtilitiesForNoti.setPixels(dst, 0, 0, dstWidth, dstHeight, dstBuffer);
        return dst;
    }
}
