...
import pro1041.team_3.swing.config.ShadowRendererForNoti;
...
public class Notification extends javax.swing.JComponent {
    ...
    private void init(String message) {
        ...
        if (type == Type.SUCCESS) {
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pro1041/team_3/icon/sucess.png")));
            lbMessage.setText("Success");
            lbMessage.setForeground(new Color(0, 153, 255));
            lbMessageText.setForeground(new Color(0, 153, 255));
        } else if (type == Type.INFO) {
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pro1041/team_3/icon/info.png")));
            lbMessage.setText("Info");
            lbMessage.setForeground(new Color(0, 0, 0));
            lbMessageText.setForeground(new Color(0, 0, 0));
        } else {
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pro1041/team_3/icon/warning.png")));
            lbMessage.setText("Warning");
            lbMessage.setForeground(new Color(255, 0, 51));
            lbMessageText.setForeground(new Color(255, 0, 51));
        }
    ...
    private BufferedImage createShadow() {
        ...
        g2.dispose();
        return new ShadowRendererForNoti(shadowSize, 0.3f, new Color(100, 100, 100)).createShadow(img);
    }
    ...
    private void initComponents() {
        ...
        lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pro1041/team_3/icon/sucess.png"))); // NOI18N

        panel.setOpaque(false);

        lbMessage.setFont(new java.awt.Font("Nunito", 1, 14)); // NOI18N
        lbMessage.setForeground(new java.awt.Color(38, 38, 38));
        lbMessage.setText("Message");

        lbMessageText.setFont(new java.awt.Font("Nunito", 0, 12)); // NOI18N
        ...
        cmdClose.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pro1041/team_3/icon/close.png"))); // NOI18N
